...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Contract is out of serves at this moment");
        _;
    }
    modifier paused() {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "this token is already owned by this address");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId], msg.sender), "you cant transfer this token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "token do exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "need a valid address to transfer to");
