...
import "../../../Blockchain-Capstone-master/zokrates/code/square/verifier.sol";
...
contract SolnSquareVerifier is ISBERC721Token {
    ...
    //SolotionArray[] private solutions;
    ...
    public returns(uint256) {
        ...
        require(solutionArray[key].Address == address(0), "require unique solution");
